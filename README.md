...
A comprehensive, curated index of Internet of Things research, protocols, technologies, and trends. Quickly navigate to essential IoT resources with detailed introductions and citations.
...
### Research & Overview
- **[IoT Development History & Trends](./docs/research/iot-history-and-trends.md)** — Comprehensive survey of IoT history, key companies, products, and current trends (2024-2025)

### Core IoT Protocols
- **[Wireless Communication](./docs/protocols/wireless-communication.md)** — Overview of wireless IoT protocols and standards
- **[MQTT](./docs/protocols/mqtt.md)** — Message Queuing Telemetry Transport protocol
- **[CoAP](./docs/protocols/coap.md)** — Constrained Application Protocol

### IoT Domains & Applications
- **[Smart Home](./docs/applications/smart-home.md)** — Home automation and connected devices
- **[Industrial IoT (IIoT)](./docs/applications/industrial-iot.md)** — Manufacturing and enterprise IoT
- **[Edge Computing](./docs/applications/edge-computing.md)** — Processing at network edge

### Security & Privacy
- **[IoT Security Overview](./docs/security/overview.md)** — Security challenges and frameworks

### Architecture & Infrastructure
- **[Cloud Platforms](./docs/architecture/cloud-platforms.md)** — AWS IoT, Azure IoT, Google Cloud IoT

### Emerging Trends (2026)
- **[5G & Beyond](./docs/trends/5g-connectivity.md)** — Next-generation connectivity

---

## How to Use This Index

1. **Quick Browse** — Use the categories above to jump to your area of interest
2. **Learn** — Each document includes introductions, key concepts, and current trends
3. **Research** — Follow citations and references for deeper study
4. **Stay Updated** — Check the [Latest Updates](#latest-updates) section for new additions

---

## Document Structure

Each topic document includes:
...
- **References & Citations** — Academic and industry sources
- **Related Topics** — Links to connected articles

---

## Latest Updates

- **2026-03-04** — Index structure and core protocols section launched
...
Want to add a new topic or improve existing documentation?
- See [CONTRIBUTING.md](./CONTRIBUTING.md) for guidelines
- Submit a pull request with your additions
- Follow the [document template](./docs/TEMPLATE.md)
...
- **Coverage** — Building comprehensive IoT knowledge base
